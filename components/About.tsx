      ...
      >
        <div className="max-w-4xl">
          ...
          <div className="mt-12 space-y-8 text-lg leading-9 text-white/70">
            ...
            <p>
              Criei o <strong className="text-white">Tecnologia e Acordes</strong>
              {" "}com o propósito de compartilhar conhecimento de forma simples, prática e
              acessível, reunindo projetos, estudos, experiências e descobertas
              sobre tecnologia, inteligência artificial e música.
            </p>
  
            <p>
              Acredito que aprender é um processo contínuo e que compartilhar esse
              conhecimento é uma das melhores formas de crescer
              profissionalmente, inspirar outras pessoas e transformar ideias em
              projetos reais.
            </p>
